...
<div class="fila">
    <div class="columna columna-1">
        <div class="title2">
        <h6>{{ __('Generador gráfico de reportes - Datos actualizados al ') }} {{ Carbon\Carbon::parse($maxDate ?? '')->format('d/m/Y') }}</h6>
        </div>
    </div>
</div>
<form action="manifests.dataEvolVer" method="get">
    ...
    <div class="fila">
        <div class="columna columna-4">
            ...
            <select id="product_id" name="product_id">
                @foreach ($products->getAll() as $index => $product)
...
<div class="fila result">
    <div class="columna columna-1">
        ...
        <label class="text-subtitle">{{ $subtitle ?? '' }}</label>
        <div class="tamano">
...
$(function() {
    ...
    $('#numMes').change(function() {
        ...
        $.ajax({
            type: "get",
            url: "manifests.dataEvolDiaVer",
            data: {'product_id':product_id,'country_id':country_id,'shipper_id':shipper_id,'consignee_id':consignee_id,'numMes':numMes},
