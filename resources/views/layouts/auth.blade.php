...
<body>
	<div class="body-login">
		<div class="login">
			<div class="box-login">
				<center>
					<a href="http://freshfruit.pe/"><img src="{{ asset('images/logo.png') }}" class="logo"></a>
				</center>
				<p>{{ __('Para acceder a nuestro portal de noticias, presione ') }}<a href="http://freshfruit.pe/">{{ __('aquí') }}</a>.</p>
                <main>
